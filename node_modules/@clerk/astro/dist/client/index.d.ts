...
import * as _clerk_shared_index_DcykZBwx from '@clerk/shared/index-DcykZBwx';
...
declare const $authStore: nanostores.ReadableAtom<{
    ...
    user: _clerk_shared_index_DcykZBwx.UserResource | null | undefined;
    sessionId: string | null | undefined;
    session: _clerk_shared_index_DcykZBwx.SignedInSessionResource | null | undefined;
    sessionStatus: "active" | "pending" | undefined;
    sessionClaims: _clerk_shared_index_DcykZBwx.JwtPayload | null | undefined;
    organization: _clerk_shared_index_DcykZBwx.OrganizationResource | null | undefined;
    orgId: string | null | undefined;
    orgRole: string | null | undefined;
    orgSlug: string | null | undefined;
    orgPermissions: _clerk_shared_index_DcykZBwx.Autocomplete<_clerk_shared_index_DcykZBwx.OrganizationSystemPermissionKey>[] | null | undefined;
    actor: _clerk_shared_index_DcykZBwx.ActClaim | null | undefined;
 ...
 */
declare const $userStore: nanostores.ReadableAtom<_clerk_shared_index_DcykZBwx.UserResource | null | undefined>;
/**
 * A client side store that is populated after clerk-js has loaded.
 ...
 */
declare const $organizationStore: nanostores.ReadableAtom<_clerk_shared_index_DcykZBwx.OrganizationResource | null | undefined>;
/**
 * A client side store that is populated after clerk-js has loaded.
 ...
 */
declare const $billingStore: nanostores.ReadableAtom<_clerk_types.BillingNamespace | undefined>;

export { $authStore, $billingStore, $clerkStore, $clientStore, $isLoadedStore, $organizationStore, $sessionListStore, $sessionStore, $signInStore, $signUpStore, $userStore, updateClerkOptions };
